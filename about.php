...
<section class="header"><img src="images/logo1.png" alt="Logo" >
...
<section class="about">
   ...
   <div class="content">
      <h3>why choose us?</h3>
      <p>Choose JobMate for a seamless, reliable experience. We connect you with verified professionals for every job—backed by real customer reviews—so you can hire with confidence. Our platform offers easy booking, fair pricing, and direct communication, ensuring that your needs are met quickly and efficiently. Plus, by supporting local workers, you’re helping to strengthen communities while receiving top-quality service. It’s a win-win for everyone.</p>
      <div class="icons-container">
         <div class="icons">
            <i class="fas fa-map"></i>
            <span>top approches</span>
         </div>
         <div class="icons">
